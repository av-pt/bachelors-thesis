...
\textcolor{teal}{(Note: very early version, will change.)}
Authorship Verification is an important task in the field of stylometry.
We hypothesize that an author has a certain phonetic preference which leads them to unconsciously imprint features into written text.
